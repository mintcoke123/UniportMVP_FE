...
- `tournamentData`: 토너먼트 이름, 종료일 `2025-02-28`, D-day 30일

### 4-2. `src/mocks/tournamentData.ts`

- 진행 중 토너먼트 3건: 종료일 `2025-02-15`, `2025-02-20`, `2025-02-10`
- 예정 토너먼트 4건: 시작일 `2025-03-01`, `2025-03-05`, `2025-03-10`, `2025-02-28`
...
- `/`, `/tournament`, `/ranking`, `/group-portfolio`, `/mock-investment`, `/stock-detail`, `/chat`, `/login`, `/signup`, `/feedback-report`, `*`(NotFound)

### 6-2. 페이지 내 한국어 문구

- `src/pages/home/page.tsx`: "진행 중인 토너먼트", "토너먼트 이름" 등
...
| **투자/토너먼트** | `investmentData.ts`, `tournamentData.ts`           | 자산, 보유 종목, 토너먼트 일정            |
