...
const StockChart = ({ stockName }: StockChartProps) => {
    ...
    script.onload = () => {
      if (containerRef.current && (window as any).TradingView) {
        new (window as any).TradingView.widget({
          autosize: true,
          symbol: 'KRX:005930',
          interval: selectedPeriod === '1D' ? '5' : selectedPeriod === '1W' ? '60' : 'D',
          timezone: 'Asia/Seoul',
          theme: 'light',
          style: '1',
          locale: 'kr',
  ...
  return (
    <div className="bg-white mt-2 px-5 py-5">
      ...
      {/* TradingView Chart */}
      <div ref={containerRef} className="w-full h-80 rounded-lg overflow-hidden border border-gray-200">
