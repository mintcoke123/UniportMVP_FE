...
export default function ChatPage() {
  ...
  const [mobilePortfolioSheetOpen, setMobilePortfolioSheetOpen] =
    useState(false);
  ...
  return (
    <div className="flex-1 min-h-0 overflow-hidden flex flex-col min-w-0 bg-teal-50 lg:bg-gray-50">
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        navigate(
                          myWaitingRoom.capacity === 1 ? "/solo" : "/stock",
                        );
                      } catch (e) {
                ...
                <div className="flex flex-col flex-1 min-h-0 overflow-hidden order-1 lg:order-2 min-w-0">
                  ...
                  <div className="flex flex-col flex-1 min-h-0 w-full min-w-0 overflow-hidden bg-white rounded-none border-0 shadow-none lg:rounded-b-2xl lg:border lg:border-t-0 lg:border-gray-200 lg:shadow-sm">
                    {rightPanelTab === "chat" && (
                      <>
                        {chatError && (
                          <div className="flex-shrink-0 py-3 bg-amber-50 border-b border-amber-200">
                          ...
                          {isTournamentEnded ? (
                            ...
                            <>
                              ...
                              <div className="flex items-center gap-2 min-w-0">
                                ...
                                >
                                  <i
                                    className="ri-send-plane-fill text-white text-lg"
                                    aria-hidden
                                  />
                                </button>
                              </div>
            ...
            <div className="flex items-center justify-center mb-3">
              <svg viewBox="0 0 200 200" className="w-28 h-28">
                {(groupPortfolioData?.holdings ?? []).map((holding, index) => {
                  ...
                  const cy = 100;
                  const r = 80;
                  const pathD = getPieSlicePathD(cx, cy, r, startAngle, angle);
                  const colors = [
                    "#14B8A6",
                    "#06B6D4",
                    "#8B5CF6",
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      ...
                      <span className="text-xs text-gray-500">
                        ...
                        {rt && (
                          <span className="text-teal-600 ml-0.5">(실시간)</span>
                        )}
                      </span>
                    </div>
                    <p
